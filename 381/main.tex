...
\begin{align}
	...
	&=\comb{10}{k}\brak{\frac{1}{3}}^k\brak{\frac{2}{3}}^{5-k}
\end{align}
CDF of X
\begin{align}
	F_X\brak{n}&=\pr{X \geq n}\\
	&=\sum_{k=0}^{n}\pr{X=k}\\
	&=\sum_{k=0}^{n}\comb{5}{k}\brak{\frac{1}{3}}^k\brak{\frac{2}{3}}^{5-k}
\end{align}
Since, according to question n here equals,
\begin{align}
	\implies F_X\brak{X\geq 4}&=\sum_{k=4}^{5}\comb{5}{k}\brak{\frac{1}{3}}^k\brak{\frac{2}{3}}^{5-k}\\
	&=\frac{11}{243}\\
	&=0.04526
\end{align}
\textbf{Gaussian}
