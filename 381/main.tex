...
\begin{table}[ht]
    ...
    \label{table:random-variables-9.3.14}
\begin{tabular}{|c|c|c|}
\hline
...
\end{tabular} 
\end{table}\\
X has binomial distribution with parameters\\
\begin{align}
	p=\frac{1}{3} ,\ n=5\\
\end{align}
Pmf of $X$ for $0 \leq k \leq 5$ is\\
\begin{align}
...
\begin{align}
	\mu_X&=n\times p=\frac{5}{3}\\
	\sigma^2_X&=np\brak{1-p}=\frac{10}{9}\\
\end{align}
Using normal distribution at $X \geq 4$\\
\begin{align}
	Z&\approx\frac{X-\mu_X +0.5}{\sigma_X}\\
	&\approx 1.74604
\end{align}
...
\end{align}
\begin{align}
P\brak{Y\geq 4} &= 1-P\brak{Z=1.74604}\\ 
\end{align}
Upon computation for $Z=1.74604$\\
\begin{align}
	P\brak{Y\geq 4} &=1-0.9596\\
	&=0.040402
\end{align} 
Therefore the Gaussian approximation for the given question is 0.040402\\
\begin{align}
P_X \approx P_Y\\
\end{align}
\begin{figure}[h]
